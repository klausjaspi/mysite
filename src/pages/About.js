            ...
            <div className="mytext-container">
                ...
                <div className="mytext-section">
                    ...
                    <div className="introtext">
                        ...
                        <p>I'm 26 years old, born in Turku. I'm currently living in Naantali with my Wife and our two cats.{"\n"}
                        ...
                        <p>I'm enthusiastic and I see challenges as opportunities to grow from.{"\n\n"}</p>
                        <p>I'm on my third year of ICT-engineer studies in Turku University of Applied Sciences. I'm proud to say that I joined Sofokus in April 2021 as a Software Developer Trainee, my aim is to continuously develop myself and my skills. 
                        My advanced special studies focus on software & project management.</p>
                    </div>
                    ...
                    <div className="mytext-section2">
                        <div className="introtext">
                            ...
                            <p>In April 2021 my half an year trainee position at Sofokus began and I learned how to do WordPress on a professional level. 
                                For example, I learned to do acf custom Gutenberg blocks of which I had not even heard of before. I'm excited and cant't wait to get more professional level experience on this!</p>
                            
                            <h4>Php</h4>
                            <p>I had no experience on php prior joining Sofokus in April 2021. I got the hang of it quite quickly and have learned a lot since. I've used php especially in WordPress acf custom block development.{"\n"}
                            I will continue to polish my skills on PHP in the future.</p>

                            <h4>Django</h4>
                            <p>I've had the opportunity to practice my skills on Django on a professional level in Sofokus. 
                            I've done few my own practice projects on Django on my own.{"\n"}I'm very eager to learn more on this subject, especially on professional level.</p>


                            <h4>HTML, CSS & JavaScript</h4>
                            <p>Before early fall of 2020 I had no experience on web development, only a deep drive to learn and master it.{"\n"}I watched many 
                            tutorials and along them began my trial & error type of learning process.{"\n"}I've learned a lot since the fall of 2020 and have had (and still do) the chance to work on these on a professional level.{"\n\n"}</p>
                            ...
                            <p>{"\n"}My second and current React project is this website aka. <a href="https://mysite-klausjaspi.vercel.app/"><u>MySite</u></a>.{"\n"}Like before, I began with tutorial but continued to refine and add parts to it, 
                            growing it to a extend.{"\n"}My goal was to learn how to develop a modern and clean website which would also work as my portfolio.{"\n\n"}I hope you've enjoyed your stay!</p>
                        </div>
                    </div>
                </div>
            </div>
